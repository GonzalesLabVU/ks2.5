...
for i = 1:numel(sessions)
    ...
    sessions(i).ks_folder = test_ks_params(sessions(i).daq_files.continuous_file.folder, rootO, chanMapFile, ops_list, 'start_ops', start_ops);
    close all
